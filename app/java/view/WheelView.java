...
//            Log.d(TAG, "向上滚动");
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(context.getResources().getColor(R.color.purple_200));
            } else {
                itemView.setTextColor(context.getResources().getColor(R.color.teal_200));
            }
        }
    }
